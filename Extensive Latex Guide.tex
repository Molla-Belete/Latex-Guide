...
%	Information	
% =================
	{\textbf{Prepared by: Mola Belete}\\
		\vspace*{1.2\baselineskip}
	\textbf{mole.ece2014@gmail.com}} \\
	\vfill
If you come across any problems, see section \ref{sec:resources} for possible\\ \vspace{1mm}
solutions or contact me at \url{mole.ece2022@gmail.com}\\ \vspace{1mm}
Happy \LaTeX-ing!
\end{titlepage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tableofcontents
...
\vspace{10.5cm}
	\subsection{Websites and Tutorials}
		...
		If you are looking for a solution for a problem you have encountered and can not find it within these files, see the templates created in the folder that orignially contained this pdf file or contact me at: 
	...
	\subsection{Typesetting Math Documents}\label{sec:exams}
		...
		\subsubsection{Typing Math Functions/Equations}
			\begin{itemize}
				\item \url{https://www.overleaf.com/learn/latex/Mathematical_expressions#Introduction}
					\begin{absquote}
					...
					\end{absquote}
				\item \url{https://www.docx2latex.com/tutorials/mathematical-equations-latex/}
					\begin{absquote}
						To cover the basics of LaTeX, its benefits, online LaTeX writing and different options available
					\end{absquote}
